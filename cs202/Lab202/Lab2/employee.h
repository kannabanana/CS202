...
class employee: public person		
{
      public:
             employee();
             employee(const employee & source);  //int for employee
             employee(char * name, char * street, char * zip, int id); //init for add/name
             employee(const person & new_employee); //init for person
             ~employee();
