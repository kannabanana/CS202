...
class name
{
      public:
             ...
             name(const name & to_copy);        //dynamically array of characters
             ~name();
...
class person:public name			//Modify this to have a derivation list
{
      public:
             ...
             person(const name &);                                  //didn't need the copy constructor - for address
            
             void copy_person(const person & to_copy);
             bool find_by_zip(const char * zip_to_compare) const;
             void read();
             void display() const;
             void wrapper_copy_address(const address & to_copy);
